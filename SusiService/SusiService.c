...
const char* deviceManufactureName = "Advantech";
const char* deviceProductName = "SUSI";
...
static const char* DEFAULT_APP_NAMES[] = { "SusiService" };
static const char* DEFAULT_DESCRIPTIONS[] = { "Advantech SUSI service for Alljoyn" };
static const char* DEFAULT_MANUFACTURERS[] = { "Advantech" };
        ...
        if (status == AJ_OK) {
...
#ifdef SUSI
                    SusiMethods_DoWork(&busAttachment);
#endif
#ifdef EVENTS_AND_ACTIONS
            ...
            if (isUnmarshalingSuccessful) {
                ...
                if (serviceStatus == AJSVC_SERVICE_STATUS_NOT_HANDLED) {
                    serviceStatus = SusiMethodsMessageProcessor(&busAttachment, &msg, &status);
                }
#endif
#ifdef EVENTS_AND_ACTIONS
                if (serviceStatus == AJSVC_SERVICE_STATUS_NOT_HANDLED) {
...
#ifdef SUSI
    SusiMethods_Finish(&busAttachment);
#endif
    return 0;
